  ...
  try {
    ...
    const updatedSettings = await prisma.userSettings.upsert({
      ...
      update: {
        ...
        newPostNotifications: newPostNotifications !== undefined ? newPostNotifications : undefined,
      },
      create: {
        userId: id,
        ...
        newPostNotifications: newPostNotifications !== undefined ? newPostNotifications : true,
      },
    });
