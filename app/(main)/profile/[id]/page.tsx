...
import ProfileHeader from "@/app/(main)/profile/[id]/_components/profile-header";
      ...
      try {
        ...
        if (session?.user) {
          const followResponse = await fetch(
            `/api/users/${session.user.id}/following/${userId}`
          );
          setIsFollowing(
            followResponse.ok && (await followResponse.json()).isFollowing
          );
        }
      } catch (error) {
          ...
          <Tabs defaultValue="posts">
            <TabsList className="grid w-full grid-cols-4">
              <TabsTrigger value="posts" className="flex items-center gap-2">
                <LucideImage className="h-4 w-4" /> Posts
              </TabsTrigger>
              <TabsTrigger
                value="professional"
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center">
                          ...
                          />
                          <label htmlFor="newPostNotifications">
